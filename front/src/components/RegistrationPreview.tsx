 ...
 const handleSubmit = async () => {
  ...
  <div className="grid grid-cols-2 gap-4">
    <input 
      ...
      className="w-full p-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-black"
    />
    <input 
      type="text"
  ...
  />
            ...
            <Button 
              variant="secondary" 
              size="xl" 
              className="w-full bg-primary-foreground text-primary hover:bg-primary-foreground/90 mt-7"
            >
              Request Detailed Quote
            </Button>

             <button onClick={handleSubmit}
              className="mt-6 inline-flex items-center justify-center gap-2 whitespace-nowrap font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-14 rounded-xl px-10 text-lg w-full bg-primary-foreground text-primary hover:bg-primary-foreground/90">
              Book
              </button>
